@extends('layout')
@section('title', 'Master Lokasi: Kecamatan')
@push('style')
...
@section('content')
    <div class="container-fluid">
        @generate_navbar(h='/',t='Master Lokasi';h='#',t="Master Lokasi Kecamatan",tt="Kecamatan")
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
                            <div class="mb-2 mb-sm-0">
                                <h5 class="card-title fw-semibold">Master Kecamatan</h5>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            datatable = $('.datatable').DataTable({
                ...
                ordering: true,
                ajax: {
                    url: "{{ route('master_location.districts.datatable') }}",
                    type: 'GET',
