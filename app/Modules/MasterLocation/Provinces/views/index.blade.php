@extends('layout')
@section('title', 'Master Lokasi: Provinsi')
@push('style')
...
@section('content')
    <div class="container-fluid">
        @generate_navbar(h='/',t='Master Lokasi';h='#',t="Master Lokasi Provinsi",tt="Provinsi")
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
                            <div class="mb-2 mb-sm-0">
                                <h5 class="card-title fw-semibold">Master Provinsi</h5>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            datatable = $('.datatable').DataTable({
                ...
                ordering: true,
                ajax: {
                    url: "{{ route('master_location.provinces.datatable') }}",
                    type: 'GET',
