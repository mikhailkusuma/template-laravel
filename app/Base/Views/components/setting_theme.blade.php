    ...
    <div class="offcanvas-body h-n80" data-simplebar>
        ...
        <div class="d-flex flex-row gap-3 customizer-box" role="group">
            <input type="radio" class="btn-check light-layout" name="theme-layout" id="light-layout"
                onclick="changeTheme('light')" autocomplete="off" />
            ...
            <input type="radio" class="btn-check dark-layout" name="theme-layout" id="dark-layout"
                onclick="changeTheme('dark')" autocomplete="off" />
        ...
        <div class="d-flex flex-row gap-3 customizer-box" role="group">
            <input type="radio" class="btn-check" onclick="themeDirection('ltr')" name="direction-l" id="ltr-layout"
                autocomplete="off" />
            <label class="btn p-9 btn-outline-primary" for="ltr-layout"><i
                    class="icon ti ti-text-direction-ltr fs-7 me-2"></i>LTR</label>

            <input type="radio" class="btn-check" onclick="themeDirection('rtl')" name="direction-l" id="rtl-layout"
                autocomplete="off" />
        ...
        <div class="d-flex flex-row gap-3 customizer-box" role="group">
            <div onclick="handleLayout('vertical')">
            ...
            <div onclick="handleLayout('horizontal')">
        ...
        <div class="d-flex flex-row gap-3 customizer-box" role="group">
            ...
            <label class="btn p-9 btn-outline-primary" for="boxed-layout" onclick="handleBoxedLayout('boxed')"><i
                    class="icon ti ti-layout-distribute-vertical fs-7 me-2"></i>Boxed</label>

            <input type="radio" class="btn-check" name="layout" id="full-layout" autocomplete="off" />
            <label class="btn p-9 btn-outline-primary" for="full-layout" onclick="handleBoxedLayout('full')"><i
        ...
        <div class="d-flex flex-row gap-3 customizer-box" role="group">
            <a href="javascript:void(0)" class="fullsidebar">
                ...
                <label class="btn p-9 btn-outline-primary" for="full-sidebar" onclick="handleSidebarType('full')"><i
            ...
            <div>
                ...
                <label class="btn p-9 btn-outline-primary" for="mini-sidebar"
                    onclick="handleSidebarType('mini-sidebar')"><i
        ...
        <div class="d-flex flex-row gap-3 customizer-box" role="group">
            ...
            <label class="btn p-9 btn-outline-primary" for="card-with-border" onclick="handlecardBorder('border')"><i
                    class="icon ti ti-border-outer fs-7 me-2"></i>Border</label>

            <input type="radio" class="btn-check" name="card-layout" id="card-without-border"
                autocomplete="off" />
            <label class="btn p-9 btn-outline-primary" for="card-without-border"
                onclick="handlecardBorder('shadow')"><i class="icon ti ti-border-none fs-7 me-2"></i>Shadow</label>
        </div>
    </div>
</div>
